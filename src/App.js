// src/App.js - Added InvitationGeneratorPage Route
import React, { useState, useEffect, useMemo } from 'react';
// --- NEW: Import InvitationGeneratorPage ---
import InvitationGeneratorPage from './InvitationGeneratorPage';
// --- END NEW ---
...
import TimelineBuilderPage from './TimelineBuilderPage';
...
const initialGuests = [ /* ... keep your initial guest data ... */ ];
const initialVendors = [ /* ... keep your initial vendor data ... */ ];
      ...
      <main className="main-content-area">
        <Routes>
          <Route
            ...
            element={
              <DashboardPage
                // Pass all necessary props for Dashboard
                guests={guests}
                ...
                getDaysInMonth={getDaysInMonth} handleEditDate={handleEditDate}
                allottedBudget={allottedBudget} totalSpentOrCommitted={totalSpentOrCommitted}
                formatCurrency={formatCurrency}
                expenses={expenses} // Pass expenses if needed by dashboard cards
                // timelineEvents={timelineEvents} // Pass timeline if needed
              />
            }
          />
          <Route
            ...
            element={
              <GuestListPage
                // Pass all necessary props for Guest List
          ...
          <Route
            ...
            element={
              <BudgetPage
                allottedBudget={allottedBudget} setAllottedBudget={setAllottedBudget}
          ...
          />
           {/* --- NEW: Invitation Generator Route --- */}
           <Route
             path="/invitations"
             element={
               <InvitationGeneratorPage
                 formattedWeddingDate={formattedWeddingDate}
                 rsvpDeadlineDate={rsvpDeadlineDate}
                 // Pass coupleNames here if you add it to App.js state
               />
             }
           />
           {/* --- END NEW --- */}
          ...
          <Route
            ...
            element={
              <ChatbotPage
                // Pass all context props needed by chatbot
                guests={guests}
                formattedWeddingDate={formattedWeddingDate}
